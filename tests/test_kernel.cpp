...
TEST_CASE("operations", "[kernel]")
{
	...
	REQUIRE(p1.exactOrientation(p2, p3, p4) == 0);
	...
	REQUIRE(q1.exactOrientation(q2, q3, q4) != 0);
	...
	REQUIRE(r1.exactOrientation(r2, r3, r4) == 0);
	...
	REQUIRE(q1.exactOrientation(r2, r3, r4) != 0);
}


TEST_CASE("Multi-threading", "[kernel]")
{
	...
	for (int i = 0; i < num_tests; i++)
	{
		...
		REQUIRE(p1.inSphere(&p2, &p3, &p4, &p5));
	}
